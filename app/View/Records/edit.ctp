<div class="admin_header">
	<h3>
		<i class="icon-edit"></i> Edit Contact Record
		<div class="button-group pull-right">
			<?php echo $this->Html->link('<i class="icon-trash"></i> Delete',array('action'=>'delete',$this->data['Record']['id'],$this->data['Record']['timesheet_id']),array('escape'=>false,'class'=>'btn'),'Are you sure you want to delete this record?') ?>
		</div>
	</h3>
</div>
<?php echo $this->Form->create('Record') ?>
	<?php echo $this->Form->input('id',array()); ?>
	<?php echo $this->Form->input('timesheet_id',array('type'=>'hidden')); ?>
<div class="row-fluid">
	<div class="span6">
...
<div class="row-fluid">
	<div class="span12">
		<?php echo $this->Form->submit('Save Changes',array('class'=>'btn btn-primary pull-right')); ?>
	</div>
</div>
